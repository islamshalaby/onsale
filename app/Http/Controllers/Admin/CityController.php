...
class CityController extends AdminController
{
    ...
    {
        $data = City::where('deleted','0')->OrderBy('created_at','desc')->get();
    ...
    {
        $city_id = $id;
        $data = Area::where('city_id',$id)->where('deleted','0')->OrderBy('created_at','desc')->get();
