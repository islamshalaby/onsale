                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>{{ app()->getLocale() == 'en' ? $row->parent->value_en : $row->parent->value_ar }}</td>
                                @if(Auth::user()->update_data)
                                    <td class="text-center blue-color"><a
                                            href="{{route('sub_option_values.edit',$row->id)}}"><i class="far fa-edit"></i></a>
                                    </td>
                                @endif
                                @if(Auth::user()->delete_data)
                                    <td class="text-center blue-color"><a
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('sub_option_values.post.index')}}" method="post" enctype="multipart/form-data">
                    @csrf
